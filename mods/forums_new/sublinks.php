...
require(AT_INCLUDE_PATH.'../'.AT_FORUMS_NEW__DIR.'/lib/module.inc.php');
require(AT_INCLUDE_PATH.'../'.AT_FORUMS_NEW__DIR.'/lib/forums.inc.php');
...
foreach ($all_forums as $shared => $forums) {
    if (is_array($forums)) {
        ...
        foreach($forums as $row) {
            ...
            $list[] = '<a href="'.url_rewrite(AT_FORUMS_NEW__DIR.'/forum/index.php?fid='.$row['forum_id'], AT_PRETTY_URL_IS_HEADER).'"'.
